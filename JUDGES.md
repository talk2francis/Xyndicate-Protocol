...
- SeasonManagerV2: `0x257A2842DBEcBDc6B6134B434BB0A224F1b8d4d1`
- Total TX count: `400+` visible through live proof surfaces and on-chain references
- MCP self-call evidence: live usage telemetry is surfaced on the Docs page
- Economy loop evidence: live payment and x402 metrics are surfaced on the Economy and Docs pages
