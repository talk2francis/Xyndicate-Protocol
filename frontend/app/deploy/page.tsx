                ...
                <div className="mt-6 rounded-3xl border border-black/10 bg-black/5 p-6 dark:border-white/10 dark:bg-white/5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <div className="truncate text-3xl font-semibold">{mySquad.squadName || mySquad.squadId || "Active squad"}</div>
                  ...
                  <div className="mt-6 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl border border-black/10 p-4 dark:border-white/10"><div className="text-xs uppercase tracking-[0.22em] text-xyn-muted dark:text-zinc-400">Squad ID</div><div className="mt-2 truncate font-semibold">{mySquad.squadName || mySquad.squadId || "Active squad"}</div></div>
